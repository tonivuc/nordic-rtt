...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_DM_TIMER2, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DM_INITIATOR_DELAY_US, 4000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DM_REFLECTOR_DELAY_US, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DM_INITIATOR_RANGING_WINDOW_US, 19000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DM_REFLECTOR_RANGING_WINDOW_US, 23000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DM_MIN_TIME_BETWEEN_TIMESLOTS_US, 8000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DM_RANGING_PIN, 37);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DM_ADD_REQUEST_PIN, 36);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_DM_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_DM_LOG_LEVEL, 3);
